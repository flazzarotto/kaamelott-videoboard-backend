...
use App\Factory\PostalAddressFactory;
use App\Serializer\Decorator\PostalAddressTransformerDecorator;
use App\Serializer\Service\RelationshipResolverService;
use Psr\Log\LoggerInterface;

class PersonJsonEncoder extends AbstractJsonEncoder
{
    const FORMAT = 'person:json';
